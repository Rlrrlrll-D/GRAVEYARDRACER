...
-- BloomIntensity 0.50, толщиной линии черепа 0.03 и золотым цветом 252,213,62.
...
--
-- И ВТОРАЯ ОСОЗНАННАЯ ЦЕНА (2026-08-10, решение юзера): на низком качестве графики
-- Roblox выключает постобработку целиком, и вместе с ней пропадает ВСЁ свечение сцены —
-- ореола нет ни у черепов, ни у стрелок старта, потому что Neon сам по себе его не
-- рисует. Проверено в опубликованной игре: на максимальном качестве свечение есть, на
-- авто-качестве нет. Игра сознательно рассчитана на среднее+ качество; чинить это
-- геометрией решили не сейчас — разбор вариантов в UIController у SKULL_STROKE.
