...
bloom.Size = 24
-- 1.35 подобрано юзером живьём (2026-08-10, клавиши порога в NeonTune) вместе с
-- BloomIntensity 0.55 и толщиной линии черепа 0.08. Порог — это «с какой яркости
-- пиксель вообще начинает светиться»: чуть ниже прежних 1.5, чтобы тонкая неоновая
-- линия за него переваливала. Величина общая на сцену, не только на черепа.
