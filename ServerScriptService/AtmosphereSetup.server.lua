...
-- Ночь ставится СРАЗУ (значения из cfg выше). Прежний плавный переход день→ночь
-- убран: он реплицировался каждые 0.1с и дрался с клиентской заставкой (та форсит
-- ночь каждый кадр) → строб света; плюс заезд первые ~2 минуты шёл на «дне».
-- Кладбище — всегда глубокая ночь, никаких переходов.

print("[AtmosphereSetup] Атмосфера кладбища настроена (ночь).")
