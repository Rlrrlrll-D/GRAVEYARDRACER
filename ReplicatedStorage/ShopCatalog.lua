...
ShopCatalog.Items = {
	...
	-- // Скины кузова -------------------------------------------------------
	{
		...
		-- Юзер: «старые цвета, только немного темнее» — ×0.9 (230); 0.78 оказалось слишком
		-- темно, старые 163 дали бы ×0.64.
		kind = "skin", color = Color3.fromRGB(230, 228, 232), material = Enum.Material.Plastic,
	},
	{
