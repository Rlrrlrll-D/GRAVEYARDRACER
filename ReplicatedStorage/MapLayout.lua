...
local MapLayout: MapLayoutType = {
	...
	-- 12 чекпоинтов равномерно по кругу (шаг 260.7 studs), но СО СДВИГОМ НА ПОЛШАГА
	-- от старта. Раньше cp1 стоял ровно в точке старта — его череп висел над первым
	-- рядом решётки. Теперь ближайшие к старту: cp1 в 130 studs впереди и cp12
	-- (он же финиш круга) в 130 studs позади, то есть за колонной (её глубина 61).
	RaceCheckpoints = {
		Vector2.new(-158.84, 95.98), Vector2.new(-240.85, 253.09), Vector2.new(-253.08, 8.01), Vector2.new(-246.53, -238.31), Vector2.new(0.77, -268.79), Vector2.new(246.32, -245.75),
		Vector2.new(235.42, -4.84), Vector2.new(227.45, 247.83), Vector2.new(102.45, 129.12), Vector2.new(120.21, -115.54), Vector2.new(-127.41, -138.97), Vector2.new(15.29, -18.46),
	},
