...
-- Высота коробки и есть кегль: надпись TextScaled, она заполняет отведённое место.
-- 2026-08-28 по просьбе юзера строка уменьшена (было 56) — тайтл при этом подрос,
-- и раньше они спорили друг с другом за внимание.
status.Size = UDim2.new(0.56, 0, 0, 40) -- уже тайтла: в узком окне не лезет на панели
