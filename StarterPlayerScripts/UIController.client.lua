...
local SKULL_COLOR = Color3.fromRGB(55, 128, 85)
...
local SNAKE = {
	...
	pathAmps = 0.35, -- размах перегиба
	travel = 1.2, -- на сколько своих длин тело проползает по кривой за подъём
}
...
local function warpGhost(a: number)
	...
	for _, v in verts do
		...
		local s = t + a * SNAKE.travel
		local curve = math.sin(s * math.pi * 2 * SNAKE.pathWaves) * SNAKE.pathAmps
