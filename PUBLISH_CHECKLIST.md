...
Платный обход существует: единоразовый возвратный взнос **100 000 Robux** за ускоренное
рассмотрение. Для первого запуска бессмысленен.

Практический вывод: **500 заходов за 60 дней — это и есть цель запуска.** Ролики из
`PROMO_SHORTS.md` работают именно на неё.
