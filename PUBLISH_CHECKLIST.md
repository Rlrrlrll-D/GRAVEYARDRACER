...
### 1.1a-ВНИМАНИЕ Право на публикацию ПРОСЕЛО — 2026-08-11, НЕ РАЗОБРАНО

**Публиковать нельзя, пока не разобрались.** На вкладке охвата появилось жёлтое
предупреждение: **«Publishing tier at risk. At next publish, your game will lose access
to this audience reach»**. Это не про уже опубликованное, а про СЛЕДУЮЩУЮ публикацию:
нажмёшь `Publish to Roblox` — и игра потеряет текущий охват.

Снимок на 2026-08-11:

| Строка | Значение |
|---|---|
| Current reach | Ages 16+ and trusted friends |
| Publishing reach (аккаунт) | All ages, но «at risk» |
| Experience content rating | Mild — Fear (Repeated/Mild), Violence (Repeated/Mild) |

Уровень «All ages» держится на четырёх требованиях (см. ниже) — 10 августа все четыре
были закрыты, значит с тех пор одно отвалилось: истёк срок, слетела двухфакторка или
прилетела модерация. ЧТО ИМЕННО — видно только за кнопкой `Manage` на этой же вкладке,
и от причины зависит, чинится это за минуту или требует повторной верификации.

Отдельно странность: `Current reach` = 16+ при рейтинге Mild. Mild обычно даёт куда
более широкий охват. Возможно, следствие того же самого; возможно, приписка «and trusted
friends» просто отражает, что игра сейчас `Private`.

### 1.1a Право на публикацию — проверено 2026-08-10 (УСТАРЕЛО, см. выше)
